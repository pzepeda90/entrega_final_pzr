        ...
        <div className="px-6 py-8">
          <div className="flex flex-col items-center mb-8">
            <div className="relative mb-4">
              <img
                src={user?.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.nombre || 'Cliente')}&background=f59e0b&color=fff&size=200`}
                alt="Avatar"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  disabled={!isEditing}
                  rows={2}
                  placeholder="Ej: Café con leche, sin azúcar"
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary disabled:bg-gray-50"
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  disabled={!isEditing}
                  rows={2}
                  placeholder="Ej: Alergia a la lactosa, sin gluten"
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary disabled:bg-gray-50"
                />
              </div>
            </div>
